...
public class LoginActivity extends Activity {
	...
	public static final String ACTION_APPLICATION_PASSED = "com.arisvn.arissmarthiddenbox.applicationpassedtest";
	public static final String EXTRA_PACKAGE_NAME = "com.arisvn.arissmarthiddenbox.extra.package.name";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        title = (TextView)findViewById(R.id.title_topbar);
        Utils.setTypeface(getApplicationContext(), title, "Roboto-Medium.ttf");
	...
	public void startActivity(String action) {
		Log.e(Utils.TAG, getClass().getName() + "::startActivity::action::"
				+ action);
		if (action == null) {
		...
		} else if (action.equals(Utils.ACTION_LOCKAPP)) {
			this.sendBroadcast(new Intent()
					.setAction(ACTION_APPLICATION_PASSED).putExtra(
							EXTRA_PACKAGE_NAME,
