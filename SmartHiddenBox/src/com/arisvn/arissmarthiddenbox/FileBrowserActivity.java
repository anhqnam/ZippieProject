...
OnClickListener, OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        menuContent = (LinearLayout)findViewById(R.id.action_panel);
        showMenu = (ImageView)findViewById(R.id.show_menu_btn);
        showMenu.setBackgroundResource(menuContent.getVisibility() == View.VISIBLE ? R.drawable.btn_hidemenu
                : R.drawable.btn_showmenu);
        showMenuPanel = (LinearLayout)findViewById(R.id.show_menu);
        ...
        if (mode == Utils.IMPORT) {
            ...
            showMenuPanel.setVisibility(View.GONE);
        } else {
            findViewById(R.id.action_panel).setVisibility(View.VISIBLE);
            showMenuPanel.setVisibility(View.VISIBLE);
	...
	class Adapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                view.rowtext = (TextView)convertView.findViewById(R.id.rowtext);
                view.imgViewFlag = (ImageView)convertView.findViewById(R.id.imageView1);
                convertView.setTag(view);
            } else {
                view = (ViewHolder)convertView.getTag();
            }
            Utils.setTypeface(getApplicationContext(), view.rowtext , "Roboto-Light.ttf");
            ...
            if (item.get(position).equalsIgnoreCase(root)) {
                view.imgViewFlag.setImageResource(R.drawable.icon_folder);
            } else if (file.isDirectory()) {
                view.imgViewFlag.setImageResource(R.drawable.icon_folder);
            } else {
                view.imgViewFlag.setImageResource(R.drawable.bg_select_file);
            }
            if (file.getName().endsWith(getResources().getString(R.string.bak))) {
                view.imgViewFlag.setImageResource(R.drawable.icon_backupfile);
            }
			return convertView;
		}
