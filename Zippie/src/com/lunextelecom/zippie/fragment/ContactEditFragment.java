...
public class ContactEditFragment extends Fragment implements OnClickListener {
	 ...
	 * @param contactDetail
	 *            the contact detail
	 * @return the contact edit fragment
	 */
    public static ContactEditFragment newContactEdit(ContactObject contactDetail) {
	 ...
	 * @return the contact edit fragment
	 */
    public static ContactEditFragment newContactAdd() {
    	ContactEditFragment frag = new ContactEditFragment();
        Bundle args = new Bundle();
        frag.setArguments(args);
        return frag;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFirstname = (EditText) view.findViewById(R.id.contactadd_fname_et_id);
        ...
        if(mContact != null){
        	mContactBack.setText(mContact.getcName());
        	mFirstname.setText(mContact.getcName());
        	if(mContact.getcFavorites()!= null){
        		mContactFavorite.setText("  Remove Contact to Favorites");
        	}
        }
